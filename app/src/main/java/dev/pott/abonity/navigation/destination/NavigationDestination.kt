...
abstract class NavigationDestination<T>(baseRoute: String) : Destination<T>(baseRoute) {
    abstract val startDestination: Destination<*>
}

abstract class NoArgNavigationDestination(baseRoute: String): NavigationDestination<Nothing>(baseRoute) {
